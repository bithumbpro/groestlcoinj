...
import org.groestlcoinj.wallet.KeyChainGroupStructure;
 ...
 */
public class ForwardingServiceBech32 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        forwardingAddress = Address.fromString(params, args[0]);//LegacyAddress.fromBase58(params, args[0]);

        System.out.println("Network: " + params.getId());
        System.out.println("Forwarding address: " + forwardingAddress);

        // Start up a basic app using a class that automates some boilerplate.
        kit = new WalletAppKit(params, Script.ScriptType.P2WPKH, KeyChainGroupStructure.DEFAULT, new File("."), filePrefix);
