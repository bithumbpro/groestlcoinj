...
public class BlockChainTest {
    ...
    public void setUp() throws Exception {
        ...
        coinbaseTo = SegwitAddress.fromKey(UNITTEST, wallet.currentReceiveKey());
    }
    ...
    public void intraBlockDependencies() throws Exception {
        ...
        // considered relevant.
        Address somebodyElse = SegwitAddress.fromKey(UNITTEST, new ECKey());
        Block b1 = UNITTEST.getGenesisBlock().createNextBlock(somebodyElse);
        ECKey key = wallet.freshReceiveKey();
        Address addr = SegwitAddress.fromKey(UNITTEST, key);
    ...
    public void coinbaseTransactionAvailability() throws Exception {
        ...
        Address addressToSendTo = SegwitAddress.fromKey(UNITTEST, receiveKey);
        ...
        for (int i = 0; i < UNITTEST.getSpendableCoinbaseDepth() - 2; i++) {
            ...
            Transaction tx2 = createFakeTx(UNITTEST, COIN, SegwitAddress.fromKey(UNITTEST, new ECKey()));
        ...
        Transaction tx3 = createFakeTx(UNITTEST, COIN, SegwitAddress.fromKey(UNITTEST, new ECKey()));
