...
public class AddressTest {
    ...
    public void decoding() throws Exception {
        if(CoinDefinition.supportsTestNet)
        {
            ...
            assertEquals("fda79a24e50ff70ff42f7d89585da5bd19d9e5cc", Utils.HEX.encode(a.getHash160()).toString());
        }

        Address b = new Address(mainParams, CoinDefinition.UNITTEST_ADDRESS);
        assertEquals("4a22c3c4cbb31e4d03b15550636762bda0baf85a", Utils.HEX.encode(b.getHash160()).toString());
    }
