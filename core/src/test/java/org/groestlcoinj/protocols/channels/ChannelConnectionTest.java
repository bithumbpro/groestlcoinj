...
import org.groestlcoinj.protocols.channels.PaymentChannelClient.VersionSelector;
import org.groestlcoinj.script.ScriptPattern;
import org.groestlcoinj.testing.TestWithWallet;
...
import org.groestlcoinj.wallet.WalletFiles;
...
import static org.groestlcoinj.protocols.channels.PaymentChannelClient.VersionSelector.*;
import static org.groestlcoinj.protocols.channels.PaymentChannelCloseException.CloseReason;
import static org.groestlcoinj.testing.FakeTxBuilder.createFakeBlock;
import static org.groestlcoin.paymentchannel.Protos.TwoWayChannelMessage.MessageType;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        org.groestlcoinj.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
