...
public class BlockTest {
    ...
    public void testWork() throws Exception {
        ...
        // This number is printed by Groestlcoin Core at startup as the calculated value of chainWork on MainNet:
        //
    ...
    public void testBlockVerification() throws Exception {
        ...
        assertEquals("000000001f1afc05cb4403f5776c863afd4c71da4e4ea184e43e41b25d071b15", block.getHashAsString());
    }
    ...
    public void testDate() throws Exception {
        Block block = PARAMS.getDefaultSerializer().makeBlock(blockBytes);
        assertEquals("9 May 2016 05:25:25 GMT", block.getTime().toGMTString());
    }
