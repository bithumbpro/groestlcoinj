...
import org.groestlcoinj.core.ECKey.ECDSASignature;
import org.groestlcoinj.crypto.EncryptedData;
import org.groestlcoinj.crypto.KeyCrypter;
import org.groestlcoinj.crypto.KeyCrypterScrypt;
...
import org.groestlcoinj.wallet.Protos.ScryptParameters;
...
import static org.groestlcoinj.core.Utils.reverseBytes;
...
public class ECKeyTest {
    ...
    public void base58Encoding() throws Exception {
        String addr = "mqAJmaxMcG5pPHHc3H3NtyXzY7kGbNSckL";
        String privkey = "92shANodC6Y4evT5kFzjNFQAdjqTtHAnDTLzqBBq4BbKUPg7sZN";
    ...
    public void base58Encoding_leadingZero() throws Exception {
        String privkey = "91axuYLa8xK796DnBXXsMbjuc8pDYxYgJyQMvFzrZ6UfXevJ9yp";
        ECKey key = DumpedPrivateKey.fromBase58(TESTNET, privkey).getKey();
        assertEquals(privkey, key.getPrivateKeyEncoded(TESTNET).toString());
    ...
    public void verifyMessage() throws Exception {
        ...
        String sigBase64 = "INsw6ks7FrUPkFlHhYkzl4wGxSCQGCuMNu8QTxGNQBPzcIcneW+uqZbnB/cYU6EOkT+MAyzgrvTAXp4a9dElQuE=";
        Address expectedAddress = LegacyAddress.fromBase58(MAINNET, "FYtbkd327Z9X8KeG23M7qLQtT76VrVnAfa");
