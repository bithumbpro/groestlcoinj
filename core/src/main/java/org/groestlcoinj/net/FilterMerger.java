...
/**
 * <p>A reusable object that will calculate, given a list of {@link org.groestlcoinj.core.PeerFilterProvider}s, a merged
 * {@link org.groestlcoinj.core.BloomFilter} and earliest key time for all of them.
 * Used by the {@link org.groestlcoinj.core.PeerGroup} class internally.</p>
 *
