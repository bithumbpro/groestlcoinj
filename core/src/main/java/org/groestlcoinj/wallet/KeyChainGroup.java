...
/**
 * <p>A KeyChainGroup is used by the {@link org.groestlcoinj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.groestlcoinj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.groestlcoinj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.groestlcoinj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
