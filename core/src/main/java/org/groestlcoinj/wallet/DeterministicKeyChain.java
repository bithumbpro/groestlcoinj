 ...
 * {@link org.groestlcoinj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link org.groestlcoinj.crypto.MnemonicCode},
 ...
 * {@link org.groestlcoinj.crypto.DeterministicKey#serializePubB58(org.groestlcoinj.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link org.groestlcoinj.crypto.DeterministicKey#deserializeB58(org.groestlcoinj.crypto.DeterministicKey, String, org.groestlcoinj.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(org.groestlcoinj.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link org.groestlcoinj.crypto.DeterministicHierarchy} and
 * {@link org.groestlcoinj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
     ...
     * The returned key can be serialized and then passed into {@link #watch(org.groestlcoinj.crypto.DeterministicKey)}
     ...
     * @see org.groestlcoinj.wallet.MarriedKeyChain
     */
