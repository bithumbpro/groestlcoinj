...
package org.groestlcoinj.wallet;
...
import org.groestlcoinj.core.listeners.*;
import org.groestlcoinj.core.AbstractBlockChain;
import org.groestlcoinj.core.Address;
import org.groestlcoinj.core.BlockChain;
import org.groestlcoinj.core.BloomFilter;
import org.groestlcoinj.core.Coin;
import org.groestlcoinj.core.Context;
import org.groestlcoinj.core.ECKey;
import org.groestlcoinj.core.FilteredBlock;
import org.groestlcoinj.core.InsufficientMoneyException;
import org.groestlcoinj.core.Message;
import org.groestlcoinj.core.NetworkParameters;
import org.groestlcoinj.core.Peer;
import org.groestlcoinj.core.PeerFilterProvider;
import org.groestlcoinj.core.PeerGroup;
...
import org.groestlcoinj.core.TransactionBag;
import org.groestlcoinj.core.TransactionBroadcast;
import org.groestlcoinj.core.TransactionBroadcaster;
import org.groestlcoinj.core.TransactionConfidence;
import org.groestlcoinj.core.TransactionInput;
import org.groestlcoinj.core.TransactionOutPoint;
import org.groestlcoinj.core.TransactionOutput;
import org.groestlcoinj.core.UTXO;
import org.groestlcoinj.core.UTXOProvider;
import org.groestlcoinj.core.UTXOProviderException;
import org.groestlcoinj.core.Utils;
import org.groestlcoinj.core.VarInt;
import org.groestlcoinj.core.VerificationException;
import org.groestlcoinj.core.TransactionConfidence.*;
import org.groestlcoinj.crypto.*;
import org.groestlcoinj.script.*;
import org.groestlcoinj.signers.*;
import org.groestlcoinj.utils.*;
import org.groestlcoinj.wallet.Protos.Wallet.*;
import org.groestlcoinj.wallet.WalletTransaction.*;
import org.groestlcoinj.wallet.listeners.KeyChainEventListener;
import org.groestlcoinj.wallet.listeners.ScriptsChangeEventListener;
...
import org.groestlcoinj.wallet.listeners.WalletEventListener;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.groestlcoinj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
     ...
     * {@link org.groestlcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.groestlcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.groestlcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.groestlcoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.groestlcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.groestlcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.groestlcoinj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.groestlcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.groestlcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.groestlcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.groestlcoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.groestlcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.groestlcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.groestlcoinj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.groestlcoinj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.groestlcoinj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.groestlcoinj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.groestlcoinj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.groestlcoinj.crypto.KeyCrypter,
     ...
     * {@link org.groestlcoinj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.groestlcoinj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.groestlcoinj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.groestlcoinj.signers.TransactionSigner.MissingSignatureException}
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.groestlcoinj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.groestlcoinj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
