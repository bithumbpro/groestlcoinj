...
import org.groestlcoin.NativeSecp256k1;
import org.groestlcoin.NativeSecp256k1Util;
import org.groestlcoin.Secp256k1Context;
...
public class ECKey implements EncryptableItem {
     ...
     * @throws org.groestlcoinj.core.ECKey.MissingPrivateKeyException if the private key is missing or encrypted.
     */
    public byte[] toASN1() {
        try {
     ...
     * usually encoded using ASN.1 format, so you want {@link org.groestlcoinj.core.ECKey.ECDSASignature#toASN1()}
    ...
    /**
     * Signs the given hash and returns the R and S components as BigIntegers. In the Bitcoin protocol, they are
     * usually encoded using DER format, so you want {@link org.groestlcoinj.core.ECKey.ECDSASignature#encodeToDER()}
    ...
    public String signMessage(String message, @Nullable KeyParameter aesKey) throws KeyCrypterException {
        ...
        Sha256Hash hash = Sha256Hash.onceOf(data);
    ...
    public static ECKey signedMessageToKey(String message, String signatureBase64) throws SignatureException {
        ...
        Sha256Hash messageHash = Sha256Hash.onceOf(messageBytes);
     ...
     * @throws org.groestlcoinj.core.ECKey.MissingPrivateKeyException if the private key bytes are missing/encrypted.
     */
     ...
     * the {@link org.groestlcoinj.core.DumpedPrivateKey#toString()} method to get the string.
     *
