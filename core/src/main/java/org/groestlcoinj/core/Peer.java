...
import org.groestlcoinj.net.StreamConnection;
import org.groestlcoinj.store.BlockStore;
import org.groestlcoinj.store.BlockStoreException;
import org.groestlcoinj.utils.ListenerRegistration;
 ...
 * {@link org.groestlcoinj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link org.groestlcoinj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link org.groestlcoinj.net.NioClientManager#openConnection(java.net.SocketAddress, StreamConnection)}
     * or
     * {@link org.groestlcoinj.net.NioClient#NioClient(java.net.SocketAddress, StreamConnection, int)}.</p>
     *
    ...
    /**
     * <p>Construct a peer that reads/writes from the given block chain. Transactions stored in a {@link org.groestlcoinj.core.TxConfidenceTable}
     ...
     * Once the pong is received the value returned by {@link org.groestlcoinj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link org.groestlcoinj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link org.groestlcoinj.core.Peer#ping()} has never
