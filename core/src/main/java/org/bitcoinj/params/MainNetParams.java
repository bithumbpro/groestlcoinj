...
public class MainNetParams extends AbstractBitcoinNetParams {
    ...
    public MainNetParams() {
        ...
        maxTargetStart = new BigInteger("000001ffffffffffffffffffffffffffffffffffffffffffffffffffffffffff", 16);
        initialHashTargetPoS = new BigInteger("00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff", 16);

        dumpedPrivateKeyHeader = 128;
        addressHeader = 23;
        p2shHeader = 10;
        segwitAddressHrp = "bca";
        port = 7333;
        packetMagic = 0x4fc11de8L;
        bip32HeaderPub = 0x0488B21E; //The 4 byte header that serializes in base58 to "xpub".
        bip32HeaderPriv = 0x0488ADE4; //The 4 byte header that serializes in base58 to "xprv"

        BCAHeight = 505888;
        BCAInitLim = 50000;
        newDifficultyAdjustmentAlgoHeight = 589500;
